      ...
      <footer className={`${styles.footer}`}>
        <div className={`${styles.container}`}>
          <div className={styles.footer_createWrapper}>
            <p className={styles.footer_createWrapper__text}>
              <Link
                className="lets-talk"
                href="email:asz93@icloud.com"
        ...
        <div className={styles.container}>
          <div className={`${styles.footer_rightsWrapper}`}>
            <div className={styles.box}>
              <p className={styles.footer_rightsWrapper__text}>
                All rights reserved 2023 © SzymborskiDev
              </p>
            </div>
            <div className={styles.box}>
              <Link
              ...
              <Link
                href="https://www.instagram.com/szymborski_a/"
                target="_blank"
              >
                Instagram
              </Link>
            ...
            <div className={styles.box}>
              <Link
                href="https://maps.app.goo.gl/Dndb4UNiTRtBWa7X7"
                target="_blank"
              >
                20°51′06″E 21°16′16″E
              </Link>
            </div>
            <div className={styles.box}>
              <Link href="#home_section" onClick={handleScroll}>
                back to top
              </Link>
            </div>
          </div>
